...
function FoodPartnerLogin() {
    ...
    async function loginFoodPartner(data) {
        setError("");
        setLoading(true);

        try {
            await authService.loginFoodPartner(data);
            ...
            console.log(
                "FOOD PARTNER LOGIN ERROR RESPONSE:",
                error.response
            );
                ...
                <div className="w-full">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-3 text-sm text-gray-400">
                            Login to manage your restaurant and upload food.
                        </p>
                    </div>
                    ...
                    {/* Login Form */}
                    <form
                        onSubmit={handleSubmit(loginFoodPartner)}
